...
from comiccatcher.api.download_manager import DownloadManager, DownloadTask
...
class DownloadTaskWidget(QFrame):
    def __init__(self, task: DownloadTask, on_cancel, on_remove):
        ...
        self.btn_action.setObjectName("flat_button")
        self.btn_action.setFixedSize(s(24), s(24))
